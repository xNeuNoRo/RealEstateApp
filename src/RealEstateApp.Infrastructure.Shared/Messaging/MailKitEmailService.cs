...
/// <summary>
/// Implementación de IEmailService usando MailKit con plantillas Razor y semáforo SMTP.
/// </summary>
public class MailKitEmailService : IEmailService
{
    ...
    ) where T : IEmailModel
    {
        ...
        try
        {
            ...
            message.From.Add(
                new MimeKit.MailboxAddress(_mailSettings.DisplayName, _mailSettings.EmailFrom)
            );
            message.To.Add(new MimeKit.MailboxAddress(string.Empty, to));
